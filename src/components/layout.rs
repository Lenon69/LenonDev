                ...
                header id="main-header" class="bg-[#1A1A1E]/80 backdrop-blur-sm fixed top-0 left-0 right-0 z-50 border-b border-slate-800/50" {
                    nav class="container mx-auto px-6 sm:px-8 lg:px-12 py-1 lg:py-2 flex flex-col md:flex-row justify-between items-center" {
                        ...
                        div class="nav-links-container text-slate-200 flex flex-nowrap justify-center items-center gap-x-1 md:gap-x-4 mt-4 md:mt-0" {
                            a href="/uses"   class="active:scale-90 active:text-brand-cyan cursor-pointer text-sm hover:text-brand-cyan px-2 py-2 rounded-md transition-all duration-175 hover:shadow-cyan-glow" { "Uses" }
                            a href="/oferta" class="active:scale-90 active:text-brand-cyan cursor-pointer text-sm hover:text-brand-cyan px-2 py-2 rounded-md transition-all duration-175 hover:shadow-cyan-glow" { "Oferta" }
                            a href="/blog"   class="active:scale-90 active:text-brand-cyan cursor-pointer text-sm hover:text-brand-cyan px-2 py-2 rounded-md transition-all duration-175 hover:shadow-cyan-glow" { "Blog" }
                            a href="/#projekty" hx-get="/content?scroll_to=projekty" hx-target="#content-area" hx-push-url="/" class="cursor-pointer text-sm hover:text-brand-cyan px-2 py-2 rounded-md transition-all duration-175 hover:shadow-cyan-glow active:scale-90 active:text-brand-cyan" { "Projekty" }
                            a href="/#kontakt" hx-get="/content?scroll_to=kontakt"  hx-target="#content-area" hx-push-url="/" class="cursor-pointer text-sm hover:text-brand-cyan px-2 py-2 rounded-md transition-all duration-175 hover:shadow-cyan-glow active:scale-90 active:text-brand-cyan" { "Kontakt" }
                        }
                    }
                }
