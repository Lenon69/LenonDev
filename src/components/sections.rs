                    ...
                    @for project in projects {
                          ...
                          hx-push-url="true"
                        {
                            @if let Some(image_url) = &project.image_url {
                                img class="w-full h-48 object-cover rounded-md mb-4 group-hover:opacity-80 transition-opacity"
                                    src=(image_url)
                                    alt=(project.title)
                                    loading="lazy"
                                    width="300"
                    ...
                    "
                {
                        ...
                        class="space-y-4 text-left"
                    {
                        ...
                        div class="text-right" {
                            button
                                type="submit"
                                class="mt-2 inline-block bg-brand-green hover:opacity-90 transition-all duration-300 text-brand-dark font-bold py-2 px-6 rounded-lg"                            {
                                "Wyślij e-mail"
                            }
                        }
                    }
