        ...
        fetchpriority="high"
         {
            ...
            div class="relative z-10 container mx-auto px-4 pt-36 md:pt-28 pb-20 lg:pb-32 text-center" {
                ...
                div class="mt-8 max-w-3xl mx-auto text-slate-300 space-y-4 text-lg text-shadow-strong" {
                    h2 { "Witaj na LenonDev. Programowanie to nie tylko mój zawód, ale przede wszystkim pasja. Eksploruję świat nowoczesnego developmentu, skupiając się na wydajności, bezpieczeństwie i elegancji kodu, którą oferuje ekosystem Rusta." }
